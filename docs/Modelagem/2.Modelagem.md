...
[Diagrama de Componentes](Modelagem/2.1.2.DiagramadeComponentes.md)

#### 2.3.1. Diagrama de Pacotes

Organiza o sistema em pacotes lógicos, uma visão mais abstraída do Diagrama de Classes.

[Diagrama de Pacotes](Modelagem/2.1.3.DiagramaPacotes.md)
...
[Diagrama de Sequencia](Modelagem/2.2.1.DiagramaSequencia.md)
...
[Diagrama de Atividades](Projeto/2.2.2.DiagramaDeAtividades.md)
...
[Diagrama de Colaboração](Projeto/2.2.3.DiagramaDeColaboracao.md)

2.2.4. Diagrama de Estados

Foca nos diferentes estados que um objeto pode assumir ao longo do tempo e nas transições causadas por eventos, representando o comportamento dinâmico de elementos do sistema.

[Diagrama de Estados](Projeto/2.2.4.DiagramaDeEstados.md)
...
[Diagrama de Casos de Uso](Projeto/2.3.1.DiagramaDeCasoDeUso.md)
...
[DER - CoffeeAtlas](Modelagem/extras/DER/DERs.md)
...
Durante o desenvolvimento do projeto, utilizamos o iTrace como ferramenta de apoio para registrar as atividades realizadas em tempo real. Ele permitiu rastrear o que cada integrante desenvolveu durante as reuniões, fornecendo uma visão clara da contribuição individual e facilitando a análise do progresso do grupo ao longo das etapas do projeto.
...
| ------ | ---------- | -------------------- | --------------------------------------------- | ------- | --------------- |
| `1.0`    | 08/05/2025 | Criação do documento | Marcos Castilhos| [Diego Carlito](https://github.com/DiegoCarlito) e [Gustavo Alves](https://github.com/gustaallves) | 09/05/2025 |

## Controle de Revisão

| Revisor(es) | O que foi realizado |
| ----------- | ------------------- |
| [Diego Carlito](https://github.com/DiegoCarlito) e [Gustavo Alves](https://github.com/gustaallves) | Ajuste caminho de imagem e adicionar descrição de itrace |
