...
<div style="text-align: center;">
    <img src="../Modelagem/foco2/Diagrama de Atividades Legenda.png"  width="400px">
</div>
...
<div style="text-align: center;">
    <img src="../Modelagem/foco2/Diagrama Atividades v4.png"  width="1500px">
</div>
...
|--------|------------|------------------------|------------------|-------------------|------------------|
| 1.0    | 09/05/2025 | Criação do documento   | [João Ribeiro](https://github.com/Joa0V)  |  [Gustavo Alves](https://github.com/gustaallves)  |    29/05/2025    |
